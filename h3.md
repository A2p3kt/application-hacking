...
![Password prompt](screenshots/{56069788-61E4-4197-A002-770AAF51C1D3}.png)

I tried entering a random string, but it was rejected:

![Failed password attempt](screenshots/{28B50253-2D1D-4F71-87E0-2D4BD62E8FC8}.png)
...
![Password found in strings output](screenshots/{36C970E8-2FA8-4AA5-833B-FD5F2C7226AB}.png)
...
![Successful authentication](screenshots/{B53EB8DE-1EEE-4308-A668-71240FF72767}.png)
...
![Password hardcoded in source](screenshots/{26F140D4-5B1A-44A3-8E6B-F1F45D15E159}.png)
...
![Password still visible with variable](screenshots/{CF6D98A9-3936-47C3-B353-BBEBAAF7F164}.png)
![Strings output showing password](screenshots/{6FCC506D-FDF7-4BCE-AB59-C61FF88CAB73}.png)
...
![Character-by-character implementation](screenshots/{0509FC02-4C1E-475E-91D5-06434E34EE23}.png)

This successfully hid the password from the `strings` command output:

![Password hidden in binary](screenshots/{A359C4D1-AB18-4ED1-94F8-9400D0157677}.png)

However, this broke the program's functionality:

![Program malfunction](screenshots/{84B9B0AD-768C-483B-B4DE-7E05C9C7C9DF}.png)
...
![Code with null terminator](screenshots/{623B2937-8762-493E-9C4D-8241FB6F99E0}.png)

The program now functions correctly while keeping the password hidden from `strings`:

![Working program with hidden password](screenshots/{1146F706-3A59-4EE6-8DC9-8E2877799D34}.png)
...
![alt text](screenshots/{A6C92E08-44AA-45A6-9769-A9B740BCB435}.png)
...
![alt text](screenshots/{2F4C66BD-D494-4994-94B0-E3846B541A59}.png)
...
![alt text](screenshots/{BCD6B93E-A2D6-460B-AE6D-FEC7C392E2B4}.png)
...
![alt text](screenshots/{CEEA58B9-12DF-429D-9BBB-FC9310429B76}.png)
