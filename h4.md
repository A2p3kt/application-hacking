...
![Ghidra application running]({0114B007-CE02-4D0B-9126-F81357F18E9D}.png)
...
![Main function highlighted in listing view]({4A3EF4DF-A9C2-479B-A647-B2DFCD0B7764}.png)

Clicking on it revealed the decompiled code in the decompiler window:

![Decompiled code initial view]({19B49CE6-6C49-46D6-B04F-549945BB8017}.png)

### Improving Readability

For better analysis, I renamed the variables to more descriptive names:

![Renamed variables for clarity]({29D90B95-6C8D-42D1-97D1-2E874F4B1765}.png)
...
![Assembly code showing JNZ instruction]({9E42B251-876E-4454-8D6F-A7D5719A2406}.png)
...
![Patched instruction]({36FEC755-7564-4B0B-96A8-2EA7A7E5BE73}.png)
...
![Export dialog]({EA7D2197-F173-4BA8-AE74-02D74F70706D}.png)
...
![Program accepting wrong password]({13315291-C060-4C19-A2BB-417968ACF29C}.png)

But it rejects the correct password `piiilos-AnAnAs`:

![Program rejecting correct password]({C0712B22-C1EC-4EC0-BD47-7992C7B11811}.png)
...
![Decompiled code showing password check]({AD2BEC73-5101-4753-A5FB-6311FC8EB9BA}.png)
...
![Assembly code showing JNZ instruction]({AC28C8D4-7611-4318-A15C-D2EDF7DECCE8}.png)
...
![Patched instruction from JNZ to JZ]({477860F0-5516-442F-9DA2-6A87955B5E74}.png)

![Patched code view]({0D4A5753-B0EE-40B2-BC8D-534E961D0E64}.png)
...
![Export dialog]({09628A51-DA72-499F-ACD1-32BE486799FD}.png)
...
![Program accepting wrong password]({0A1C2ED7-F9BE-4836-9087-73E0B0930068}.png)

But it rejects the correct password:

![Program rejecting correct password]({A2837886-3B71-4174-AEC5-7CB020196060}.png)
...
![alt text]({4D7BF860-FCF4-463F-8DA6-BEB0574E7FE7}.png)
...
![alt text]({EE52B790-5E63-4350-A7F2-11A01C4B7DC1}.png)
...
![alt text]({B8BED726-F40E-44F1-9BDC-95D6367651B5}.png)
...
![alt text]({2F217409-CEDE-4F9D-B492-85AEADD66148}.png)
...
![alt text]({5FCD44FD-7236-4B5A-83D5-7229068128E1}.png)
...
![alt text]({38684B8E-6811-4275-925C-A1AD8BD967C6}.png)
...
![alt text]({9293F169-3577-4C1D-B20E-DF30A6016407}.png)
...
![Program rejecting random input]({C73BE1D3-891A-45D9-8EC1-930CE5AAEF30}.png)
...
![Initial decompiled code view]({55C0C887-8EF1-4B33-B199-3589206F4ECC}.png)

### Improving the Readability

For better analysis, I renamed the variables based on their functionality:

![Renamed variables for clarity]({5D47F4A5-F47C-45C0-BA75-37B5CD8E9946}.png)
...
![Program accepting the correct password]({C1F20E33-0543-4FC2-A606-423CEE88F842}.png)
